...
std::vector<AircraftData> InitializeAircraftData()
{
	...
	data[static_cast<int>(AircraftType::kEagle2)].m_hitpoints = 100;
	data[static_cast<int>(AircraftType::kEagle2)].m_speed = 200.f;
	data[static_cast<int>(AircraftType::kEagle2)].m_fire_interval = sf::seconds(1);
	data[static_cast<int>(AircraftType::kEagle2)].m_texture = TextureID::kEagle2;
...
std::vector<PointBoxData> InitializePointBoxData()
{
	...
	data[static_cast<int>(PointBoxType::kPlusOne)].m_speed = 100.f; //Fastest box cause its lower points //Fastest box cause its lower points
	...
	data[static_cast<int>(PointBoxType::kPlusTwo)].m_speed = 85.f; //Slightly slower //Slightly slower
	...
	data[static_cast<int>(PointBoxType::kPlusThree)].m_speed = 75.f; //Keep the slowest //Keep the slowest
